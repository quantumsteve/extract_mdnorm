...
Eigen::Matrix3f LoadExtrasWorkspace::getRotMatrix() {
...
std::vector<Eigen::Matrix3f> LoadExtrasWorkspace::getSymmMatrices() {
...
Eigen::Matrix3f LoadExtrasWorkspace::getUBMatrix() {
  HighFive::DataSet dataset = m_file.getDataSet("ubmatrix");
  return dataset.read<Eigen::Matrix3f>();
}

std::vector<bool> LoadExtrasWorkspace::getSkipDets() {
