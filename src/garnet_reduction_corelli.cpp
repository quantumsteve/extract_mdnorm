...
TEST_CASE("calculateIntersections") {
  SECTION("t0") {
    ...
    LoadExtrasWorkspace extras(GARNET_ROT_NXS);
    ...
    LoadSolidAngleWorkspace solidAngle(GARNET_SA_NXS);
    ...
    LoadFluxWorkspace flux(GARNET_FLUX_NXS);
    ...
    LoadEventWorkspace eventWS(GARNET_EVENT_NXS);
